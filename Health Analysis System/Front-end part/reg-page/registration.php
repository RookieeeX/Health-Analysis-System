...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	$mql = "INSERT INTO users(username,f_name,l_name,email,phone,password)
     VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."',
     '".$_POST['phone']."','".md5($_POST['password'])."')";
	mysqli_query($db, $mql);
...
<body style="background-image: url('images/pbg.jpg');  background-repeat: no-repeat;
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#mainNavbarCollapse">&#9776;</button>
                                     <a class="navbar-brand" href="index.php"> <img style="background-color:white" width="130"  height="60" class="img-rounded " src="images/wku.png" alt=""> </a>
                     ...
                     <div class="col-md-8" style="margin-left:200px">
					   ...
					   <span style="color:green;font-size:20px,text-align:center;">
								<?php echo $success; ?>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p style="margin-left:230px"> <input style="width:150px" type="submit" value="Register" name="submit" class="btn theme-btn"> </p>
                                    </div>
                                 </div>
                              </form>
